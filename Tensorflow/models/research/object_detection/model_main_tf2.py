...
def main(unused_argv):
    ...
    if FLAGS.checkpoint_dir:
        ...
        if FLAGS.use_tpu:
            ...
            print("Use num workers")
            strategy = tf.distribute.experimental.MultiWorkerMirroredStrategy()
        else:
            print("Use mirrored strat")
            strategy = tf.compat.v2.distribute.MirroredStrategy()

        with strategy.scope():
            # print(FLAGS.pipeline_config_path, FLAGS.model_dir, FLAGS.num_train_steps, FLAGS.use_tpu,
            #       FLAGS.checkpoint_every_n, FLAGS.record_summaries)
